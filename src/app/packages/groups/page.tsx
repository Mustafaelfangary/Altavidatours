...
export default function GroupPackagesPage() {
  ...
  useEffect(() => {
    const fetchPackages = async () => {
      try {
        const res = await fetch('/api/packages?category=group');
        if (res.ok) {
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="mb-12 text-center">
          ...
          <p className="text-xl text-gray-300 max-w-2xl mx-auto">
            Perfect for corporate groups, organizations, and large parties. Travel together, save together.
          </p>
        </div>
        ...
        {loading ? (
                  ...
                  <div className="p-6">
                    ...
                    {pkg.price && (
                      <div className="flex items-center text-amber-300 mb-3">
                        ...
                        <span className="font-semibold">From ${pkg.price} per person</span>
                      </div>
                    )}
          ...
          <div className="text-center py-12">
            <p className="text-xl text-gray-400 mb-4">No group packages available at the moment.</p>
            <Link href="/packages">
