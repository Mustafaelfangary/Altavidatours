        ...
        <Container maxWidth="lg" className="relative z-10">
          <AnimatedSection animation="fade-in">
            <div className="text-center text-white mb-12">
              ...
              <h1 className="text-6xl md:text-7xl font-heading font-bold mb-6 bg-gradient-to-r from-pharaoh-gold via-white to-pharaoh-gold bg-clip-text text-transparent drop-shadow-2xl animate-pulse">
              ...
              <p className="text-xl md:text-2xl font-light mb-8 bg-gradient-to-r from-pharaoh-gold via-white to-green-400 bg-clip-text text-transparent max-w-4xl mx-auto animate-fade-in hover:animate-pulse hover:scale-105 transition-all duration-700">
                <span className="hover:bg-gradient-to-r hover:from-green-400 hover:via-white hover:to-pharaoh-gold hover:bg-clip-text hover:text-transparent transition-all duration-500">
        ...
        <Container maxWidth="lg">
          <AnimatedSection animation="fade-in">
            <div className="text-center mb-16">
              <h2 className="text-5xl font-heading font-bold bg-gradient-to-r from-green-400 via-pharaoh-gold to-green-400 bg-clip-text text-transparent mb-6 animate-pulse hover:animate-bounce hover:scale-110 transition-all duration-500">
                <span className="hover:bg-gradient-to-r hover:from-pharaoh-gold hover:via-white hover:to-green-400 hover:bg-clip-text hover:text-transparent transition-all duration-700">
                  🌿 About Azhar Dahabiya 🌿
                </span>
              </h2>
              <div className="w-24 h-1 bg-gradient-to-r from-green-400 via-pharaoh-gold to-green-400 mx-auto rounded-full mb-8 animate-shimmer hover:w-32 hover:h-2 transition-all duration-500"></div>
              <p className="text-xl bg-gradient-to-r from-ancient-stone via-green-400/60 to-ancient-stone bg-clip-text text-transparent leading-relaxed max-w-4xl mx-auto hover:bg-gradient-to-r hover:from-pharaoh-gold hover:via-green-400 hover:to-pharaoh-gold hover:bg-clip-text hover:text-transparent hover:animate-pulse transition-all duration-700">
          ...
          <AnimatedSection animation="slide-up" delay={200}>
            <div className="mb-20">
              <h3 className="text-4xl font-heading font-bold bg-gradient-to-r from-green-400 via-pharaoh-gold to-green-400 bg-clip-text text-transparent text-center mb-12 animate-bounce hover:animate-pulse hover:scale-110 transition-all duration-500">
                <span className="hover:bg-gradient-to-r hover:from-pharaoh-gold hover:via-white hover:to-green-400 hover:bg-clip-text hover:text-transparent transition-all duration-700">
