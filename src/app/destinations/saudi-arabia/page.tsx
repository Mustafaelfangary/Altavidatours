...
export default function SaudiaArabiaPage() {
    ...
    const fetchDestination = async () => {
      try {
        ...
        if (res.ok) {
          ...
          const saudi = data.find((d: any) => d.country === 'Saudi Arabia');
          setDestination(saudi);
        }
      } catch (error) {
  ...
  <div className="min-h-screen bg-linear-to-b from-gray-900 via-gray-800 to-gray-900">
      ...
      <div className="relative h-96 bg-black/50 pt-24 overflow-hidden">
        ...
        <div className="container mx-auto px-4 h-full flex flex-col justify-center">
          ...
          <p className="text-2xl text-gray-200">Experience the magic of Arabia</p>
        </div>
      </div>
          ...
          <>
            <div className="max-w-4xl mx-auto mb-16">
              <p className="text-lg text-gray-300 leading-relaxed mb-8">
                {destination.description || 'Discover the breathtaking landscapes, rich culture, and ancient heritage of Saudi Arabia. From the towering cliffs of AlUla to the vibrant streets of Jeddah, experience the perfect blend of tradition and modernity.'}
              </p>
              ...
              <div className="bg-linear-to-b from-gray-800 to-gray-900 rounded-lg p-8 mb-12">
                ...
                <ul className="space-y-3 text-gray-300">
                  <li className="flex items-start">
                    ...
                    <span>AlUla - The Rose City with stunning rock formations</span>
                  </li>
                  <li className="flex items-start">
                    <span className="text-amber-400 mr-3">•</span>
                    <span>Jeddah - Historic Old Town and Red Sea beaches</span>
                  </li>
                  <li className="flex items-start">
                    <span className="text-amber-400 mr-3">•</span>
                    <span>Madain Saleh - UNESCO World Heritage Site</span>
                  </li>
                  <li className="flex items-start">
                    <span className="text-amber-400 mr-3">•</span>
                    <span>Riyadh - Modern capital with authentic culture</span>
                  </li>
                  <li className="flex items-start">
                    <span className="text-amber-400 mr-3">•</span>
                    <span>Desert experiences and Bedouin culture</span>
                  </li>
                </ul>
              </div>
