...
export default function DubaiDestinationPage() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-nile-blue/10">
      <Navbar />
      <main className="pt-20">
        <section className="relative max-w-6xl mx-auto px-4 pb-16">
          <div className="relative h-[360px] rounded-3xl overflow-hidden shadow-2xl mb-10">
            <Image
              src="/Destinations/Dubai.webp"
              alt="Dubai skyline and desert luxury"
              fill
            ...
            <div className="absolute inset-0 flex flex-col justify-center items-start px-8 md:px-12 text-white space-y-4">
              ...
              <p className="max-w-xl text-lg md:text-xl text-white/90 leading-relaxed">
                Michelin‑starred dining, private yacht sunsets and exclusive desert lodges – Dubai curated with a
                truly boutique touch.
              </p>
              <div className="flex flex-wrap gap-4 mt-2">
                <Link href="/packages">
                  <Button className="bg-pharaoh-gold hover:bg-pharaoh-gold/90 text-black font-semibold px-8 py-6 text-lg rounded-full">
                    Discover Dubai Stays
                  </Button>
                </Link>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="md:col-span-2 space-y-6">
              <h2 className="text-3xl md:text-4xl font-serif font-bold text-nile-blue flex items-center gap-3">
                <span>Modern Luxury, Effortlessly Arranged</span>
              </h2>
              <PharaonicDecoration variant="section" size="sm" />
              <p className="text-lg text-ancient-stone leading-relaxed">
                From sky‑high suites to quiet desert sanctuaries, we orchestrate Dubai so that every transfer,
                reservation and experience feels seamless and personal.
              </p>
              <p className="text-lg text-ancient-stone leading-relaxed">
                Combine Dubai with Egypt, Jordan or Turkey for a multi‑country journey that flows elegantly from city
                lights to ancient wonders.
              </p>
            </div>
            <div className="space-y-4 bg-white/80 rounded-2xl shadow-xl border border-pharaoh-gold/20 p-6">
              <h3 className="text-xl font-semibold text-nile-blue mb-2">Signature Dubai Experiences</h3>
              <ul className="space-y-2 text-ancient-stone text-sm">
                <li>• Private yacht charters on the Arabian Gulf</li>
                <li>• Desert safaris with gourmet dinners under the stars</li>
                <li>• Sky‑view cocktails and fine‑dining reservations</li>
                <li>• Tailor‑made shopping and spa days</li>
              </ul>
            </div>
          </div>
        </section>
